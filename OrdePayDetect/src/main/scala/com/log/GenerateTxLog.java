...
public class GenerateTxLog {
    ...
    //随机生成城市和省份
    public static String sample_payes() {
    ...
    public static String generateLog() {
        ...
        String payes = sample_payes();

        String txid = sample_txid();

        long timestamp=sample_timestamp();

        String log1 = txid+","+payes+","+timestamp;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //dest生成日志的路径
        String dest = "D:\\workspace\\bigdata\\flink\\UserBehaviorAnalysis\\OrdePayDetect\\src\\main\\resources\\tx.csv";
